          ...
          <div class="our_solution_category">
            <div class="solution_cards_box">
              <div class="solution_card">
                ...
                <div class="solu_description">
                  <p>
                   You can edit all the details of hostel.
                   But code can't be changed.
                  </p>
                  <a href="./edithostelsup.php"><button  type="button" class="read_more_btn">Edit</button></a>
                </div>
              </div>
              <div class="solution_card">
                <div class="hover_color_bubble"></div>
                ...
                <div class="solu_title">
                  <h3>Update capacity and vacancy</h3>
                </div>
                <div class="solu_description">
                  <p>
                    Update your hostel capacity and vacancy.
                  </p>
                 <a href="./upcap.php"> <button type="button" class="read_more_btn">Update</button></a>
                </div>
              </div>
            </div>
            <!--  -->
            <div class="solution_cards_box sol_card_top_3">
              <div class="solution_card">
                ...
                <div class="solu_description">
                  <p>
                    Check the details of applied applicant and change the status of application.
                  </p>
                  <a href="./showapp.php"><button type="button" class="read_more_btn">Show applications</button></a>
                </div>
              </div>
              <div class="solution_card">
                <div class="hover_color_bubble"></div>
