...
<html lang="en">
  ...
  <body>
    <div class="container">
      <?php
      include 'edithostel1.php';
      ?>
    </div>
    <div class="container my-3">
    <form action="edithostel.php" method="post" autocomplete="on">
  <!-- 2 column grid layout with text inputs for the first and last names -->
  <h2>Edit hostel</h2>
  
  <!--  hostel Name input -->
  <div class="form-outline mb-4">
    <input type="text" id="form6Example3" class="form-control" name="hostel" pattern="[a-zA_Z]+" />
